                                    ...
                                    "7" -> {
                                        when (usuarioEncontrado.tipoUsuario) {
                                            TipoUsuario.ORGANIZADOR -> {
                                                ...
                                                var diaFinal: Int?; var mesFinal: Int?; var anoFinal: Int?
                                                var horaFinal: Int?; var minutoFinal: Int?
                                            ...
                                            TipoUsuario.ORGANIZADOR -> {
                                                ...
                                                when (possuiEventos) {
                                                    ...
                                                    true -> {
                                                        ...
                                                        for (evento in listaEventos) {
                                                            when {
                                                                evento.id == idEvento && evento.organizadorEmail ==
                                                                        usuarioEncontrado.email && evento.statusEvento -> eventoAlterando = evento
                                                            }
                                                        }
                                                                            ...
                                                                            when (vincularPrincipal) {
                                                                                "1" -> {
                                                                                    ...
                                                                                    when (idValido) {
                                                                                        ...
                                                                                        else -> println("ERRO: Vinculação não realizada.")
                                                                                    }
                                                                                }
